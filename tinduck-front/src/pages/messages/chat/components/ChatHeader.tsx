...
export const ChatHeader: React.FC<HeaderChatProps> = ({receiverProfile}) => {
  return (
    <div className="z-10 fixed top-[75px] w-full bg-white container-app">
      <div className="flex flex-row items-center gap-[30px] w-full px-[25px] my-[10px] relative">
        <div className="h-[60px] w-[60px] rounded-full overflow-hidden bg-black">
          <Link
        ...
        <div>
          <div className="absolute bottom-[0px] left-[75px] bg-[#535bf2] rounded-[10px] py-[3px] px-[14px] text-xl font-bold text-white">
