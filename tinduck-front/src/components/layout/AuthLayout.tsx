  ...
  return !isAuth ? (
    <div className={"h-full flex flex-col item-center justify-center"}>
      <div className={""}>
        <div
          className={
            "text-[50px] text-center py-[15px] my-auto mx-auto w-full font-black text-[#535bf2] flex flex-row items-center justify-center gap-[5px] rounded-b-sm overflow-hidden"
          }
        >
          <p>TinDuck</p>
          <div>
